...
public class Enemy extends Player {
      ...
      public void shoot(double angle, double force) {
            double[] shot = enemyDifficulty(enemyShot(xPos + size / 2, yPos + size / 2), difficulty); // Inner function
                                                                                                      // finds shot by
                                                                                                      // bruteforce,
                                                                                                      // outer function
                                                                                                      // adds
      ...
      public double[] enemyShot(int x, int y) {
            ...
            int iteration = 1000; // 1000/30FPS = 30sec simulering, but devided by refinement factor

            int iterationAngle = 45; // Antal udførte kast
            int iterationForce = 10; // Antal udførte kast
            ...
            for (int iA = 0; iA < iterationAngle; iA++) {
                  for (int iF = 0; iF < iterationForce; iF++) {
                        ...
                        ArrayList<Double> data = new ArrayList<Double>(); // Initialize and reset arraylist for every
                                                                          // iteration
